...
<body>
		...
		<c:if test="${ not empty errorMessages }">
			...
			<!-- <form>～</form>で囲まれたエリア：ユーザが入力するエリアです。登録ボタンを押すと、入力値をパラメータとしてServletへ送信します。 -->
			<!-- ★ここめっちゃ大事★　action="signup" ＝ WebSeervletアノテーションに「signup」がついているServletを探すmethod="post" = そこのdoPostへ -->
